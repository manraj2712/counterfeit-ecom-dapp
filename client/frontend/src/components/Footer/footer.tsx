...
const Footer = () => {
    return (
        <div className=' mt-4 flex flex-col w-full bg-indigo-950 text-sm'>
            <div className=' flex p-14'>
                ...
                <div className=' flex w-2/5  flex-1 px-4 border-l gap-2 text-[.8rem] text-white'>
                    ...
                    <div className=' flex flex-col gap-2'>
                        ...
                        <p className='leading-6 font-medium'>CryptoCommerce Internet Private Limited,
            ...
            <div className=' border-t p-4 text-center text-white'>
                <h1>Built By Manraj & Arihant -- @Alrights reserved-{
                    // get year
